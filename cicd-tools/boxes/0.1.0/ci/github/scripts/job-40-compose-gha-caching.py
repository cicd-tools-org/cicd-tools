"""Add GitHub Actions caching to docker compose services."""
...
def add_gha_caching_to_compose_file(
    compose_file_path: str, service_name: str, version: str
) -> None:
  with open(compose_file_path, 'r', encoding="utf-8") as fh:
  ...
  with open(compose_file_path, 'w', encoding="utf-8") as fh:
    fh.write("---\n")
